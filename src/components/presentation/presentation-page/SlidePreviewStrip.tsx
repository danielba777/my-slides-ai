        ...
        {slides.map((slide, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-16 h-16 rounded-[10px] flex-shrink-0 flex items-center justify-center p-[1px] transition-all duration-200 shadow-sm bg-white border border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
